...
class PhysicalPageAddress{
    ...
    uint64_t block_id;
    uint64_t page_id;
    PhysicalPageAddress(const uint32_t channel_id=0, const uint32_t chip_id=0, const uint32_t die_id=0,
                        const uint32_t plane_id=0, const uint64_t block_id=0, const uint64_t page_id=0)
