...
class NandDrive {
public:
    static constexpr uint64_t DIE_CNT    = 1;
    static constexpr uint64_t PLANE_CNT  = 1;
    static constexpr uint64_t BLOCK_CNT  = 64;
    static constexpr uint64_t PAGE_CNT   = 8;
    static constexpr uint64_t PG_SZ      = 16384;
