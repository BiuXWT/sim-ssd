...
class NandDrive {
public:
    static constexpr uint32_t DIE_CNT    = 1;
    static constexpr uint32_t PLANE_CNT  = 1;
    static constexpr uint32_t BLOCK_CNT  = 64;
    static constexpr uint32_t PAGE_CNT   = 8;
    static constexpr uint32_t PG_SZ      = 16384;
